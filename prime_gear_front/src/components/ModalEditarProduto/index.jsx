...
const ModalEditarProduto = ({ onClose, produtoId }) => {
  ...
  async function obterProduto() {
    ...
    try {
      const response = await axios.get(`http://primegear.site:8080/produto/${produtoId}`)
  ...
  async function editarProduto(e) {
    ...
    try {
      const response = await axios.put(`http://primegear.site:8080/editar-produto/${produtoId}`, formData)
