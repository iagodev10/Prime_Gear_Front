...
const ModalEditarMarca = ({ onClose, onSave, categoriaAtual,id }) => {
  ...
  async function obterInfosMarca(idMarca){
    try {
       const response = await axios.get('http://primegear.site:8080/get-marca/'+idMarca)
  ...
  const handleSalvar = async (e) => {
   ...
   formData.append("imagem1",imgSalvar)
    ...
    try {
        const response = await axios.put('http://primegear.site:8080/editar-marca/'+id, formData)
