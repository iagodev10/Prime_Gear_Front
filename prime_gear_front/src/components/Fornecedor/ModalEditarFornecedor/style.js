...
export const ModalHeader = styled.div`
    ...
    h2 { margin: 0; font-size: 1.4rem; font-weight: 600; color: #333; }
    button {
...
export const Form = styled.form`
    ...
    input {
        ...
        font-size: 1rem; background-color: #fff; transition: 0.3s;
        &:focus { outline: none; border-color: #000; box-shadow: 0 0 0 2px rgba(0,0,0,0.1); }
    }
...
export const SubmitButton = styled.button`
    ...
    &:hover { background: #1a1a1a; transform: translateY(-2px); }
`;