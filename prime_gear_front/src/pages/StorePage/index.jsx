...
function Store() {
  ...
  const [isStickyFixed, setStickyFixed] = useState(false);
          ...
          {!isMobile && (
            <div
              ...
              style={{
                width: "280px",
                flexShrink: 0,
                position: isStickyFixed ? "fixed" : "sticky",
                top: isStickyFixed ? 80 : "8vh",
                left: isStickyFixed ? stickyLeft : "auto",
                alignSelf: "flex-start",
                maxHeight: isStickyFixed
              ...
              >
                ...
                >
                  ...
                  {expandedFilters.avaliacoes && (
                    <div style={{ paddingTop: "12px" }}>
                      <label style={labelStyle}>
                        <input type="checkbox" style={inputStyle} />1 estrela
                      </label>

                      <label style={labelStyle}>
                        <input type="checkbox" style={inputStyle} />2 estrelas
                      </label>

                      <label style={labelStyle}>
                        <input type="checkbox" style={inputStyle} />3 estrelas
                      </label>

                      <label style={labelStyle}>
                        <input type="checkbox" style={inputStyle} />4 estrelas
                      </label>

                      <label style={labelStyle}>
                        <input type="checkbox" style={inputStyle} />5 estrelas
                      </label>
                    </div>
                  )}
                </div>
                    ...
                    {marcas.map((marca) => (
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            toggleBrand(marca.nome_marca || marca)
                          }
                          style={{
                            width: "16px",
                            height: "16px",
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                Cadastre-se para receber descontos
              </p>
              <p
                style={{
                  color: "#f5f5f5",
              ...
              >
                Cadastre-se para receber ofertas e atualizações da empresa.
              </p>
            </div>
          </div>
          <div
