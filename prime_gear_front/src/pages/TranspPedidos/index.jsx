    ...
    const fetchAllData = async () => {
      ...
      try {
        ...
        const transpResponse = await axios.get(
          `http://primegear.site:8080/get-dados-transp/${user.email_user}`,
        ...
        const pedidosResponse = await axios.get(
          `http://primegear.site:8080/get-pedidos-transportadora/${transportadoraData.cod_transportadora}`,
          { withCredentials: true }
        );
  ...
  const alterarStatus = async (id, novoStatus) => {
    try {
      ...
      const response = await axios.patch(
        `http://primegear.site:8080/atualizar-status-pedido/${pedido.codPedido}`,
        { status: novoStatus },
        {
          headers: {
