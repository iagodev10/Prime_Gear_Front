  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const statsResponse = await axios.get('http://primegear.site:8080/admin/estatisticas');
        setStats(statsResponse.data);

   
        const alertasResponse = await axios.get('http://primegear.site:8080/admin/alertas');
        setAlertas(alertasResponse.data);

        const pedidosResponse = await axios.get('http://primegear.site:8080/admin/pedidos-recentes');
